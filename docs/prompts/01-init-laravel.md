...
- Pest 3 instalado en lugar de PHPUnit. (Versión efectiva: 3.8.6 — ver commits `chore: pin platform PHP to 8.2.30 and downgrade to Pest 3` y `docs: revert stack version references from Pest 4 to Pest 3`.)
